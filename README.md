...
Power BI analysis of Brazilian e-commerce data focused on **sales performance, customer behavior, product categories, payment methods, and seller performance**.
